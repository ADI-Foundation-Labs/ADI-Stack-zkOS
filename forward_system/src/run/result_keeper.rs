...
// }
//
// impl From<TxProcessingOutputOwned> for zksync_os_interface::types::TxProcessingOutputOwned {
//     fn from(value: TxProcessingOutputOwned) -> Self {
//         Self {
//             status: value.status,
//             output: value.output,
//             contract_address: value.contract_address.map(|a| a.to_be_bytes().into()),
//             gas_used: value.gas_used,
//             gas_refunded: value.gas_refunded,
//             computational_native_used: value.computational_native_used,
