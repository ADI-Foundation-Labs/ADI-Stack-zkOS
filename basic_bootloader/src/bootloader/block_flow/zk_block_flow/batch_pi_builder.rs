...
impl BatchPublicInputBuilder {
    ...
    /// Please note, that pubdata, l2 -> l1 logs, and l1 -> l2 txs hashes should be added separately using corresponding public fields/methods.
    ///
    pub fn apply_block(
        &mut self,
...
impl EnforcedTxHashesAccumulator for BatchPublicInputBuilder {
    fn empty() -> Self {
        Self::new()
    }
